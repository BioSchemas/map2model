...
1. After executing ```run.py``` command a web browser will ask a Google Account authentication. **Log in using an account that has [Bioschemas GDrive Folder](https://drive.google.com/open?id=0B8yXU9SkT3ftaWJtTGYyTTJjck0) in it's Drive.** 
